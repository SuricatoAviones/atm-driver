...
namespace atm_driver.Migrations
{
    ...
    [Migration("20250426160542_ServicioIDAddedCajero")]
    partial class ServicioIDAddedCajero
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("atm_driver.Models.Models_Auxiliares.Transaccion_Codigo_Model", b =>
                {
                    b.Property<int>("transaccion_codigo_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("transaccion_codigo_id"));

                    b.Property<string>("codigo_operacion")
                        .IsRequired()
                        .HasMaxLength(10)
                    ...
                    b.Property<int>("pos_ini")
                        .HasMaxLength(1)
                        .HasColumnType("int")
                        .HasColumnName("pos_ini");
                    ...
                    b.Property<string>("tipo_cuenta_origen")
                        .IsRequired()
                        .HasMaxLength(2)
                        .HasColumnType("nvarchar(2)")
                        .HasColumnName("tipo_cuenta_origen");
                    ...
                    b.HasKey("transaccion_codigo_id");

                    b.ToTable("Transaccion_codigo");
                });

            modelBuilder.Entity("atm_driver.Models.Models_Auxiliares.Transaccion_Evento_Model", b =>
                {
                    b.Property<int>("transaccion_evento_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("transaccion_evento_id"));
                    ...
                    b.HasKey("transaccion_evento_id");

                    b.ToTable("Transaccion_evento");
                });
            ...
            modelBuilder.Entity("atm_driver.Models.Transacciones_Model", b =>
                {
                    ...
                    b.Property<DateTime?>("fecha_mensaje_respuesta")
                        .HasColumnType("datetime2")
                        .HasColumnName("fecha_mensaje_respuesta");
